...
const AuthField = ({ label, icon: Icon, type = "text", required, value, onChange, placeholder, minLength, autoComplete, name }) => {
      ...
      <div className="relative flex items-center">
        ...
        {isPassword && (
          <button
            ...
            tabIndex={-1}
            className="absolute right-3 flex items-center text-slate-400 transition hover:text-slate-600 dark:text-slate-500 dark:hover:text-slate-300"
